...
const Commandes = () =>{
    ...
    const reccord = cmd.slice(firstindex, lastindex);
    const nbrePage = Math.ceil(cmd.length/reccordPage);
    const number = [...Array(nbrePage + 1).keys()].slice(1);
    /*********************** */
    /*Fonction pour afficher les commandes d'une caisse précise*/
    useEffect(()=>{Hist.Commandes(setCMD, nom);},[])
                ...
                <main class="app-main"> 
                    <div class="app-content-header"> 
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h1 class="h1"><b>Liste des commandes de la {nom}</b></h1>
                            </div>
                            <div class="col-sm-3"></div>
                        </div>
                                                            ...
                                                            <table class="table table-default table-striped">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Numéro</th>
                                                                        <th>Total plats</th>
                                                                        <th>Total compléments</th>
                                                                        <th>Total boissons</th>
                                                                        <th>Montant</th>
                                                                        <th>Caisse</th>
                                                                        <th>Action</th>
                                                                    </tr>
                                                                ...
                                                                <tbody>
                                                                    {reccord.map((cmds => (
                                                                        <tr key={cmds.id}>
                                                                            <td>{cmds.numero}</td>
                                                                            <td>{cmds.nbreplats}</td>
                                                                            <td>{cmds.nbrecomplements}</td>
                                                                            <td>{cmds.nbreboissons}</td>
                                                                            <td>{cmds.montant} XAF</td>
                                                                            <td>{cmds.caisses}</td>
                                                                            <td class="mailbox-date">
                                                                                <Link to={"/factures/"+cmds.numero+"/"+cmds.montant+""}><button class="btn btn-primary"><i class="bi bi-eye"></i></button></Link>{" "}
