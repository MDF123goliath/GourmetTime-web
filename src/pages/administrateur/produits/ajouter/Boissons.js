...
const Boissons = () =>{
    ...
    /*Boissons*/
    /*Variables reletifs aux champs de la boisson*/
    ...
    /*Fonction d'ajout d'une boisson*/
    const Ajouter = () => {
        if(formData.nom !== "" && formData.categorie !== "" && formData.prix !== "" && img !== ""){
            ...
            axios.post(Config.url+Config.port8082+"/API/Boissons/newBoissons", donnee, {
                headers: {
                                ...
                                <div class="col-md-8">
                                    <div class="card card-success">
                                        <div class="card-header">
                                            <h3 class="card-title">Ajout d'une nouvelle boissons</h3>
                                        </div>
                                        <div class="card-body">
                                        <form method="Post">
                                                <div class="row">
